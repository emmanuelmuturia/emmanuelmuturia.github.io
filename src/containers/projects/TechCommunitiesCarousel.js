            ...
            <div className="experience-carousel" ref={carouselRef}>
                {bigProjects.projects.map((proj, i) => (
                    <a
                        ...
                        href={proj.footerLink && proj.footerLink[0] ? proj.footerLink[0].url : "#"}
                        target="_blank"
                        rel="noopener noreferrer"
                        tabIndex={0}
                        style={{ marginRight: i === bigProjects.projects.length - 1 ? 0 : undefined }}
                    >
                        <div className="circle-logo-wrapper">
                            <img src={proj.image} alt={proj.projectName} className="carousel-logo" />
                        </div>
